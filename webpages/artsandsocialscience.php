...
<body>
    ...
    <!-- Image Section -->
    <div class="msclogo">
        <img src="../images/cllge-CASS.png" alt="COLLEGE 0f Arts And Social Science">
    </div>
    ...
    <div class="two-column">
        ...
        <div class="text-column">
            <h2 class="college-heading">COLLEGE OF ARTS AND SOCIAL SCIENCE</h2>

        <!-- Video Section -->
    <div class="video-container">
        <video controls>
            <source src="../images/artsandsocialscience.MOV" type="video/mp4">

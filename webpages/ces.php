...
<body>
    ...
    <!-- Image Section -->
    <div class="msclogo">
        <img src="../images/cllge-ces.png" alt="COLLEGE 0f Arts And Social Science">
    </div>
    ...
    <div class="two-column">
     ...
     <!-- Right text column -->
        <div class="text-column">
            <h2 class="college-heading">COLLEGE OF ENVIRONMENTAL SCIENCES</h2>

    <div class="video-container">
        <video controls>
            <source src="../images/enviscie.MOV" type="video/mp4">

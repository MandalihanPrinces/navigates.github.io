...
<body>
    ...
    <!-- Image Section -->
    <div class="msclogo">
        <img src="../images/cllge-cics.png" alt="COLLEGE 0f Arts And Social Science">
    </div>
    ...
    <!-- Right text column -->
        <div class="text-column">
            <h2 class="college-heading">COLLEGE OF INFORMATION AND COMPUTING SCIENCES</h2>

    <div class="video-container">
        <video controls>
            <source src="../images/it.MOV" type="video/mp4">
            ...
            Bachelor of Science in Information System<br>
             (Boac Campus: Level III AACCUP Re-accredited, Sta Cruz Branch: Level II AACCUP Re-accredited)

...
<body>
    ...
    <!-- Image Section -->
    <div class="msclogo">
        <img src="../images/cllge-of-education.png" alt="COLLEGE 0f Arts And Social Science">
    </div>
    ...
    <!-- Right text column -->
        <div class="text-column">
            <h2 class="college-heading">COLLEGE OF EDUCATION</h2>

    <div class="video-container">
        <video controls>
            <source src="../images/educ.MOV" type="video/mp4">

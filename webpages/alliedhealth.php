...
<body>
    ...
    <!-- Image Section -->
    <div class="msclogo">
        <img src="../images/cllge-cahs.png" alt="COLLEGE 0f Allied and Health sciences">
    </div>
    ...
    <!-- Right text column -->
        <div class="text-column">
            <h2 class="college-heading">COLLEGE OF ALLIED AND HEALTH SCIENCE</h2>

        <!-- Video Section -->
    <div class="video-container">
        <video controls>
            <source src="../images/cahs.MOV" type="video/mp4">
            ...
            Midwifery Program (Member: APSOM)<br>

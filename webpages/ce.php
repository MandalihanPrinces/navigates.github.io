...
<body>
    ...
    <!-- Image Section -->
    <div class="msclogo">
        <img src="../images/cllge-of-engineering.png" alt="COLLEGE 0f Arts And Social Science">
    </div>
    ...
    <!-- Right text column -->
        <div class="text-column">
            <h2 class="college-heading">COLLEGE OF ENGINEERING</h2>

        <!-- Video Section -->
    <div class="video-container">
        <video controls>
            <source src="../images/engineering.MOV" type="video/mp4">
            ...
            Bachelor of Science in Mechanical Engineering (BSME) (AACCUP Level II Re-accredited)
        </p>

...
<body>
    ...
    <!-- Image Section -->
    <div class="msclogo">
        <img src="../images/cllge-cit.png" alt="COLLEGE 0f Arts And Social Science">
    </div>
    ...
    <!-- Right text column -->
        <div class="text-column">
            <h2 class="college-heading">COLLEGE OF INDUSTRIAL TECHNOLOGY </h2>

    <div class="video-container">
        <video controls>
            <source src="../images/industrial.MOV" type="video/mp4">
